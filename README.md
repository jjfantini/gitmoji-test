...
<h3 align="center">gitmoji-test</h3>

<div align="center">

  [![Open in Dev Containers](https://img.shields.io/static/v1?label=Dev%20Containers&message=Open&color=blue&logo=visualstudiocode)](https://vscode.dev/redirect?url=vscode://ms-vscode-remote.remote-containers/cloneInVolume?url=https://github.com/jjfantini/gitmoji-test)
  ...
  [![GitHub Issues](https://img.shields.io/github/issues/jjfantini/gitmoji-test.svg)](https://github.com/jjfantini/gitmoji-test/issues)
  [![GitHub Pull Requests](https://img.shields.io/github/issues-pr/jjfantini/gitmoji-test.svg)](https://github.com/jjfantini/gitmoji-test/pulls)
...
1. ⭐️ _Dev Container (with container volume)_: click on [Open in Dev Containers](https://vscode.dev/redirect?url=vscode://ms-vscode-remote.remote-containers/cloneInVolume?url=https://github.com/jjfantini/gitmoji-test) to clone this repository in a container volume and create a Dev Container with Cursor AI/VS Code.
